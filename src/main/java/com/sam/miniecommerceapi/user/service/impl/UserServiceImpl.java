...
import com.sam.miniecommerceapi.common.util.DisplayNameUtils;
...
public class UserServiceImpl implements UserService {
	...
	public User findByIdentifier(String identifier) {
		return repository.findByIdentifier(identifier).orElseThrow(() -> BusinessException.of(ErrorCode.RESOURCE_NOT_FOUND));
	}
	...
	public User findByEmail(String email) {
		return repository.findByEmail(email).orElseThrow(() -> BusinessException.of(ErrorCode.RESOURCE_NOT_FOUND));
	}
	...
	public User findById(Long id) {
		return repository.findById(id).orElseThrow(() -> BusinessException.of(ErrorCode.RESOURCE_NOT_FOUND));
	}

	@Override
	public User createUser(UserCreationRequest request) {
		if (existsByEmail(request.getEmail())) throw BusinessException.of(ErrorCode.USER_EMAIL_ALREADY_EXISTS);
